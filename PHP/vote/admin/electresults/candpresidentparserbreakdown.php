...
<TITLE>Vote.ph : Election Results Input on Presidential Candidates By Region</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>Presidential Candidates Regional Breakdown (Parser)</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS INPUT ON PRESIDENTIAL CANDIDATES REGIONAL BREAKDOWN (VIA PARSER)</B></DIV>
<BR>
<BR>
<?PHP if (empty($hassubmit)) { ?>

<?PHP
	$fp = fopen($votehome."/vote/admin/electresults/electresultspresidentbreakdown.txt",'r');
	$content = fread($fp,filesize($votehome."/vote/admin/electresults/electresultspresidentbreakdown.txt"));
	fclose($fp);
?>
...
<BR>
<BR>
<B>Enter presidential input in comma-delimited format:</B><BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	$query	= "UPDATE candpresidents SET regionNCRvotes=".strval($regionNCRvotes).", region1votes=".strval($region1votes).
...
<TABLE WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($candpresidentsrow = mysql_fetch_array($candpresidents)) { ?>
		...
		<?PHP } ?>
			...
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['totvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['regionNCRvotes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region1votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region2votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region3votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region4votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region5votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region6votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region7votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region8votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region9votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region10votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region11votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region12votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['regionARMMvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['regionCARvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['region13votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candpresidentsrow['Absenteevotes']); ?></SPAN></TD>
		</TR>
	<?PHP } ?>
</TABLE>
<?PHP mysql_free_result($candpresidents); ?><BR>
<?PHP
	$fp = fopen($votehome."/vote/admin/electresults/electresultspresidentbreakdown.txt",'w');
	fwrite($fp,$comments);
	fclose($fp);
?>
Click <A HREF="/vote/electresults/candpresidentlistbreakdown.php">here</A> to view presidential election results by regional breakdown.<BR>
