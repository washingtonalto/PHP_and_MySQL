...
<TITLE>Vote.ph : Election Results Input on Senatorial Candidates By Region</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>Senatorial Candidates Regional Breakdown (Parser)</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS INPUT ON SENATORIAL CANDIDATES REGIONAL BREAKDOWN (VIA PARSER)</B></DIV>
<BR>
<BR>
<?PHP if (empty($hassubmit)) { ?>

<?PHP
	$fp = fopen($votehome."/vote/admin/electresults/electresultssenatorbreakdown.txt",'r');
	$content = fread($fp,filesize($votehome."/vote/admin/electresults/electresultssenatorbreakdown.txt"));
	fclose($fp);
?>
...
<BR>
<BR>
<B>Enter senatorial input in comma-delimited format:</B><BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	$query	= "UPDATE candsenators SET regionNCRvotes=".strval($regionNCRvotes).", region1votes=".strval($region1votes).
...
<TABLE WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($candsenatorsrow = mysql_fetch_array($candsenators)) { ?>
		...
		<?PHP } ?>
			...
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['totvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionNCRvotes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region1votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region2votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region3votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region4votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region5votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region6votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region7votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region8votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region9votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region10votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region11votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region12votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionARMMvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionCARvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region13votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['Absenteevotes']); ?></SPAN></TD>
		</TR>
	<?PHP } ?>
</TABLE>
<?PHP mysql_free_result($candsenators); ?><BR>
<?PHP
	$fp = fopen($votehome."/vote/admin/electresults/electresultssenatorbreakdown.txt",'w');
	fwrite($fp,$comments);
	fclose($fp);
?>
Click <A HREF="/vote/electresults/candsenatorlistbreakdown.php">here</A> to view senatorial election results by regional breakdown.<BR>
