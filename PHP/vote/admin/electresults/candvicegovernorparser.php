...
<TITLE>Vote.ph : Election Results Input on Vice Governor Candidates</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>Vice Governor Candidates (Parser)</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS INPUT ON VICE GOVERNOR CANDIDATES (VIA PARSER)</B></DIV>
<BR>
<BR>
...
<B>Enter vice governors input in comma-delimited format:</B><BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	$query	= "UPDATE candvicegovernors SET numvotes=".strval($numvotes).", is_proclaimed='".trim(strtoupper($isproclaimed)).
