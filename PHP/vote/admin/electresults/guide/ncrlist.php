...
<TITLE>Vote.ph : List of NCR Guide</TITLE>
</HEAD>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>LIST OF NCR GUIDE</B></DIV>
<BR>
<?PHP while ($ncrmunicityrow = mysql_fetch_array($ncrmunicity)) { ?>
	<B><?PHP echo $ncrmunicityrow['ncrmunicity']; ?></B><BR>	
<?PHP } ?>
<BR>							
