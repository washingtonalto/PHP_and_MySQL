...
<TITLE>Vote.ph : NCR Municipality/City Election Results Notes</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>NCR Municipality/City Election Results Notes</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>NCR MUNICIPALITY/CITY ELECTION RESULTS NOTES</B></DIV>
<BR>
...
<B>Synax:</B><BR>
[NCR City or Municipality],[Display Mayor Results (Y/N)?],[Display Vice Mayor Results (Y/N)?],[Display Councilor Results (Y/N)?],[Mayor Notes],[Vice Mayor Notes],[Councilor Notes];<BR>
<B>Examples of inputs:</B><BR>
CITY OF MANILA,Y,Y,Y,As of 5:30 pm Comelec,As of 2:30 pm Comelec,As of 2:30 pm Comelec;<BR>
<FORM ACTION=<?PHP echo $PHP_SELF; ?> METHOD="post">
<B>Enter NCR Municipality/City input in comma-delimited format:</B><BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	list($ncrmunicity,$isdispmayresult,$isdispvmayresult,$iscounresult,$maycomment,$vmaycomment,$councomment) = split(",",$linearray[$ctr]);
	$query	= "UPDATE nationalcapitalregion SET is_maydispresult='".trim($isdispmayresult)."', is_vmaydispresult='".trim($isdispvmayresult).
			  ...
			  "' WHERE (UCASE(name) = '".trim(strtoupper($ncrmunicity))."')"; 
	echo $query."<BR>";		  
