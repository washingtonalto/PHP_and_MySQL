...
<TITLE>Vote.ph : Provincial Municipality/City Statistics</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>Provincial Municipality/City Statistics</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>PROVINCIAL MUNICIPALITY/CITY STATISTICS</B></DIV>
<BR>
...
<B>Synax:</B><BR>
[Provincial City/Municipality],[Province],[No. of Barangays],[No. of Precincts],[Land Area],[No. of Male Registered Voters],[No. of Female Registered Voters],[No. of Registered Voters],[No. of Actual Voters],[Fact Sheet];<BR>
<B>Examples of inputs:</B><BR>
Daet, Camarines Norte,123,1232,123,123,123,234,234,Fact Sheet;<BR>
<FORM ACTION=<?PHP echo $PHP_SELF; ?> METHOD="post">
<B>Enter provincial municipality/city statistics input in comma-delimited format:</B><BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	list($municity,$province,$numbarangays,$numprecincts,$landarea,$nummaleregvoters,$numfemaleregvoters,$numregvoters,$numactualvoters,$factsheet) = split(",",$linearray[$ctr]);
	$query = "SELECT municity.municity_id FROM municity, legdistricts, provinces 
	          WHERE (UCASE(municity.name) = '".strtoupper(trim($municity)).
			  "') AND (UCASE(provinces.name) = '".strtoupper(trim($province)).
