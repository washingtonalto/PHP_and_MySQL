...
<TITLE>Vote.ph : Provincial Statistics</TITLE>
</HEAD>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>PROVINCIAL STATISTICS</B></DIV>
<BR>
...
<B>Synax:</B><BR>
[Province],[No. of Barangays],[No. of Precincts],[Land Area],[No. of Male Registered Voters],[No. of Female Registered Voters],[No. of Registered Voters],[No. of Actual Voters],[Fact Sheet];<BR>
...
for ($ctr=0;$ctr < sizeof($linearray)-1;$ctr++) {
	...
	list($provinces,$numbarangays,$numprecincts,$landarea,$nummaleregvoters,$numfemaleregvoters,$numregvoters,$numactualvoters,$factsheet) = split(",",$linearray[$ctr]);
	$query	= "UPDATE provinces SET numbarangays='".trim($numbarangays)."', numprecincts='".trim($numprecincts).
