...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($presidentrow = mysql_fetch_array($president)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $presidentrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$presidentrow['id']."&amp;type=president"; ?>><?PHP echo $presidentrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>		
	...
	<?PHP while ($vicepresidentrow = mysql_fetch_array($vicepresident)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $vicepresidentrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$vicepresidentrow['id']."&amp;type=vicepresident"; ?>><?PHP echo $vicepresidentrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($senatorrow = mysql_fetch_array($senator)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $senatorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$senatorrow['id']."&amp;type=senator"; ?>><?PHP echo $senatorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($representativerow = mysql_fetch_array($representative)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $representativerow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$representativerow['id']."&amp;type=representative"; ?>><?PHP echo $representativerow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($governorrow = mysql_fetch_array($governor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $governorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$governorrow['id']."&amp;type=governor"; ?>><?PHP echo $governorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($vicegovernorrow = mysql_fetch_array($vicegovernor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $vicegovernorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$vicegovernorrow['id']."&amp;type=vicegovernor"; ?>><?PHP echo $vicegovernorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($provboardmemberrow = mysql_fetch_array($provboardmember)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $provboardmemberrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$provboardmemberrow['id']."&amp;type=provboardmember"; ?>><?PHP echo $provboardmemberrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($mayorrow = mysql_fetch_array($mayor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $mayorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$mayorrow['id']."&amp;type=mayor"; ?>><?PHP echo $mayorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($vicemayorrow = mysql_fetch_array($vicemayor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $vicemayorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$vicemayorrow['id']."&amp;type=vicemayor"; ?>><?PHP echo $vicemayorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($councilorrow = mysql_fetch_array($councilor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $councilorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$councilorrow['id']."&amp;type=councilor"; ?>><?PHP echo $councilorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candpresidentrow = mysql_fetch_array($candpresident)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candpresidentrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candpresidentrow['id']."&amp;type=candpresident"; ?>><?PHP echo $candpresidentrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>		
	...
	<?PHP while ($candvicepresidentrow = mysql_fetch_array($candvicepresident)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candvicepresidentrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candvicepresidentrow['id']."&amp;type=candvicepresident"; ?>><?PHP echo $candvicepresidentrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candsenatorrow = mysql_fetch_array($candsenator)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candsenatorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candsenatorrow['id']."&amp;type=candsenator"; ?>><?PHP echo $candsenatorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($candrepresentativerow = mysql_fetch_array($candrepresentative)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candrepresentativerow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candrepresentativerow['id']."&amp;type=candrepresentative"; ?>><?PHP echo $candrepresentativerow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($candgovernorrow = mysql_fetch_array($candgovernor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candgovernorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candgovernorrow['id']."&amp;type=candgovernor"; ?>><?PHP echo $candgovernorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>
	...
	<?PHP while ($candvicegovernorrow = mysql_fetch_array($candvicegovernor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candvicegovernorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candvicegovernorrow['id']."&amp;type=candvicegovernor"; ?>><?PHP echo $candvicegovernorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candboardmemrow = mysql_fetch_array($candboardmem)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candboardmemrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candboardmemrow['id']."&amp;type=candboardmem"; ?>><?PHP echo $candboardmemrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candmayorrow = mysql_fetch_array($candmayor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candmayorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candmayorrow['id']."&amp;type=candmayor"; ?>><?PHP echo $candmayorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candvicemayorrow = mysql_fetch_array($candvicemayor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candvicemayorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candvicemayorrow['id']."&amp;type=candvicemayor"; ?>><?PHP echo $candvicemayorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
	...
	<?PHP while ($candcouncilorrow = mysql_fetch_array($candcouncilor)) { ?>
			...
			<?PHP } else { ?>
				<TR>
			<?PHP } ?>
			<TD><?PHP echo $ctr; ?></TD><TD><?PHP echo $candcouncilorrow['label']; ?></TD><TD><A HREF=<?PHP echo "/vote/admin/input/deleteform.php?id=".$candcouncilorrow['id']."&amp;type=candcouncilor"; ?>><?PHP echo $candcouncilorrow['fullname']; ?></A></TD></TR>	
	<?PHP } ?>	
