...
<!--======================= End of MetaHeaders =================-->
<TITLE>Vote.ph : Add News, Events, Activity</TITLE>
</HEAD>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ADD NEWS, EVENTS AND ACTIVITIES</B></DIV>
<BR>
<?PHP if (empty($hassubmit)) { ?>

<FORM ACTION="<?PHP echo $PHP_SELF; ?>" METHOD="post">
<B>Date to Start Display (YYYY-MM-DD):</B>&nbsp;&nbsp;<INPUT TYPE="text" NAME="start_date" SIZE="12"><BR>
<B>Date to Stop Display (YYYY-MM-DD):</B>&nbsp;&nbsp;<INPUT TYPE="text" NAME="end_date" SIZE="12"><BR>
...
<?PHP
	...
	$query = "INSERT INTO newsevents SET body = '".addslashes($body).
