...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($coalitionrow = mysql_fetch_array($coalition)) { ?>
			...
			<TD>
			    <A HREF=<?PHP echo "/vote/admin/inputparty/editcoalition.php?coalitionid=".$coalitionrow['id']; ?>>
			       <?PHP
	...
	<?PHP while ($partyrow = mysql_fetch_array($party)) { ?>
			...
			<TD>
			    <A HREF=<?PHP echo "/vote/admin/inputparty/editparty.php?partyid=".$partyrow['id']; ?>>
			       <?PHP
