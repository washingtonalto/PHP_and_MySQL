...
$sortorder = " ORDER BY totvotes DESC, acronym";
if (empty($optiontype)) {
	$optiontype = 18;
}
if (!empty($submit)) {
...
$query = "SELECT party.party_id, party.name, party.acronym, (region1votes + region2votes + region3votes + region4votes + region5votes + region6votes + region7votes + region8votes + region9votes + region10votes + region11votes + region12votes + region13votes + regionARMMvotes + regionCARvotes + regionNCRvotes + Absenteevotes) As totvotes, 
	...
	WHERE candpartylist.party_id = party.party_id ".$sortorder." LIMIT 40";
...
<TITLE>Vote.ph : Election Results on Party-List Candidates With Regional Breakdown (Top 40 Only)</TITLE>
</HEAD>
...
<A HREF="/vote/electresults/candpartylist.php"><B>Election Results on Party-List Candidates</B></A>
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>Regional Breakdown (Top 40 Only)</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS ON PARTY-LIST CANDIDATES WITH REGIONAL BREAKDOWN (TOP 40 ONLY)</B></DIV>
<BR>
<BR>		
...
<B>Notes:</B><BR>
<?PHP require ("$votehome/vote/admin/electresults/electresultspartylistbreakdown.txt"); ?>
<BR>
<BR>
<TABLE WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($candpartylistrow = mysql_fetch_array($candpartylist)) { ?>
		...
		<?PHP } ?>
			...
			<TD ALIGN="left"><A HREF=<?PHP echo "/vote/partydet.php?partyid=".$candpartylistrow['party_id']; ?>>
			    <SPAN CLASS="breakdownstat">
					<?PHP echo $candpartylistrow['acronym']; ?>	
				</SPAN></A></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 18) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['totvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 15) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['regionNCRvotes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 1) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region1votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 2) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region2votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 3) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region3votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 4) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region4votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 5) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region5votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 6) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region6votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 7) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region7votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 8) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region8votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 9) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region9votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 10) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region10votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 11) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region11votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 12) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region12votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 13) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['regionARMMvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 14) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['regionCARvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 16) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['region13votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 17) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candpartylistrow['Absenteevotes']); ?></SPAN></TD>
		</TR>
	<?PHP } ?>
</TABLE>
