...
$query = "SELECT provinces.province_id, legdistricts.dist_num, provinces.name As provincename, represultcomment
...
<TITLE>Vote.ph : Election Results on Representatives Candidates of <?PHP echo $districtnum.$legdistrow['provincename']; ?></TITLE>
</HEAD>
...
<B>Election Results on Representatives Candidates of <?PHP echo $districtnum.$legdistrow['provincename']; ?></B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS ON REPRESENTATIVES CANDIDATES OF <?PHP echo strtoupper($districtnum.$legdistrow['provincename']); ?></B></DIV>
<BR>
...
<TD ALIGN="left" VALIGN="top"><B>#</B></TD><TD ALIGN="left" VALIGN="top"><B>Name</B></TD><TD ALIGN="left" VALIGN="top"><B>Votes</B></TD><TD ALIGN="left" VALIGN="top"><B>Status</B></TD>
	...
	<TD>
		<A HREF=<?PHP echo "/vote/candrepresentativesdet.php?candrepresentativeid=".$candrepresentativesrow['representative_id']; ?>>
