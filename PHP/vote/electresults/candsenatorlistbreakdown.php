...
<TITLE>Vote.ph : Election Results on Senatorial Candidates With Regional Breakdown</TITLE>
</HEAD>
...
<A HREF="/vote/electresults/candsenatorlist.php"><B>Election Results on Senatorial Candidates</B></A>
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>ELECTION RESULTS ON SENATORIAL CANDIDATES WITH REGIONAL BREAKDOWN</B></DIV>
<BR>
<BR>		
...
<TABLE WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP while ($candsenatorsrow = mysql_fetch_array($candsenators)) { ?>
		...
		<?PHP } ?>
			...
			<TD ALIGN="left"><A HREF=<?PHP echo "/vote/candsenatorsdet.php?candsenatorid=".$candsenatorsrow['senator_id']; ?>>
			...
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 18) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['totvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 15) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionNCRvotes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 1) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region1votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 2) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region2votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 3) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region3votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 4) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region4votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 5) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region5votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 6) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region6votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 7) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region7votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 8) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region8votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 9) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region9votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 10) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region10votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 11) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region11votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 12) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region12votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 13) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionARMMvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 14) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['regionCARvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 16) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['region13votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 17) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($candsenatorsrow['Absenteevotes']); ?></SPAN></TD>
		</TR>
	<?PHP } ?>
</TABLE>
