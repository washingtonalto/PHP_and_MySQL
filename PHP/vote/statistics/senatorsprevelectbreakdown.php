...
$query = "SELECT senator_id, lastname,firstname, middleinitial, (region1votes + region2votes + region3votes + region4votes + region5votes + region6votes + region7votes + region8votes + region9votes + region10votes + region11votes + region12votes + region13votes + regionARMMvotes + regionCARvotes + regionNCRvotes + Absenteevotes) As totvotes, 
	...
	FROM senatorsprevelect ".$sortorder;
$senatorsprevelect =  getqueryresults($query);

?>

<!--======================= End of MetaHeaders =================-->

<TITLE>Vote.ph : 2001 Senatorial Election Results with Regional Breakdown</TITLE>
</HEAD>
...
<IMG SRC="/vote/graphics/rightarrow.gif" WIDTH="25" HEIGHT="12" BORDER="0" ALT="-->">
<B>2001 Senatorial Election Results</B>
</TD>
</TR>
</TABLE>
...
<BR>
<DIV ALIGN="center" STYLE="background-color: #E6E6E6;"><B>2001 SENATORIAL ELECTION RESULTS WITH REGIONAL BREAKDOWN</B></DIV>
<BR>
<BR>		
...
<B>Notes:</B><BR>
<?PHP require ("$votehome/vote/admin/electresults/electresultssenatorbreakdown.txt"); ?>
<BR>
<BR>
<TABLE WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0" ALIGN="center">
	...
	<?PHP $ctr=0; ?>
	<?PHP while ($senatorsprevelectrow = mysql_fetch_array($senatorsprevelect)) { ?>
		...
		<?PHP } ?>
			...
			<TD ALIGN="left"><SPAN CLASS="breakdownstat">
					<?PHP echo $senatorsprevelectrow['lastname'].", ".$senatorsprevelectrow['firstname'] ?>	
					<?PHP if(!empty($senatorsprevelectrow['middleinitial'])) { ?>
      					&nbsp;<?PHP echo $senatorsprevelectrow['middleinitial']."."; ?>
					<?PHP } ?>	    
				</SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 18) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['totvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 15) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['regionNCRvotes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 1) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region1votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 2) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region2votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 3) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region3votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 4) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region4votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 5) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region5votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 6) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region6votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 7) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region7votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 8) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region8votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 9) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region9votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 10) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region10votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 11) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region11votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 12) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region12votes']); ?></SPAN></TD>			
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 13) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['regionARMMvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 14) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['regionCARvotes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 16) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['region13votes']); ?></SPAN></TD>
			<TD ALIGN="right" NOWRAP><SPAN STYLE=<?PHP if ($optiontype == 17) { echo "color:red; font-weight : bold;"; } else { echo "color:black;"; } ?> CLASS="breakdownstat"><?PHP echo number_format($senatorsprevelectrow['Absenteevotes']); ?></SPAN></TD>
		</TR>
	<?PHP } ?>
</TABLE>
<?PHP mysql_free_result($senatorsprevelect); ?>
<BR>
<BR>
<BR>	
